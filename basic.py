 ...
 ㅇㅇpubg.op.gg/user/{}?server={}".format(pubg_id,pubg_server)
        ...
        if pubg_hash:
            ...
            if not('message' in json_data):
                ...
                embed.set_author(name=(pubg_id + '#' + arg3), icon_url="https://cdn.discordapp.com/app-icons/408863311980134400/79dbc20fd7291f87b16edfb5c735cfbc.png")
                ...
                embed.set_footer(text='By pinebudweiser :)', icon_url="https://cdn.discordapp.com/app-icons/408863311980134400/79dbc20fd7291f87b16edfb5c735cfbc.png")
                await bot.say(embed=embed)
            else:
                await bot.say(u'전적이 아직 기록되지 않았습니다.')
        else:
            await bot.say(u'유저가 존재하지 않습니다.')
        
bot.run('input your bot token')
